...
export default function About() {
  ...
  return (
    <section id="about" className="w-full py-16 sm:py-20 px-4 sm:px-6 lg:px-32 text-white">
      <div className="w-full max-w-4xl mx-auto space-y-6 sm:space-y-8 text-center" data-aos="fade-up">
        
        {/* Section Title */}
        <h1
          data-aos="zoom-in"
          className="text-3xl sm:text-4xl lg:text-5xl uppercase font-poppins font-semibold text-white tracking-tight"
        >
          About
        </h1>
        <div
          className="h-[3px] w-16 sm:w-20 bg-red-600 mx-auto"
          data-aos="zoom-in"
        ></div>
        ...
        <a
          href="#cta"
          className="inline-block bg-red-600 hover:bg-white text-white hover:text-red-600 font-semibold text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg transition duration-300 mx-auto"
        >
