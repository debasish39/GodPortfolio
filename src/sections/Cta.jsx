...
export default function Cta() {
  ...
  return (
    <section
      id="cta"
      className="w-full py-20 px-6 lg:px-32 text-white text-center"
    >
      <div
        data-aos="zoom-in"
        className="bg-[#1A1A1A] backdrop-blur-md rounded-2xl 
         hover:shadow-[0_0_35px_rgba(239,68,68,0.5)]
        transition-all duration-300 px-10 py-16 max-w-4xl mx-auto flex flex-col items-center"
      >
        ...
        <button
          data-aos="zoom-in"
          data-aos-delay="400"
          className="bg-red-600 hover:bg-white text-white hover:text-red-600 font-semibold text-lg px-6 py-3 rounded-lg 
