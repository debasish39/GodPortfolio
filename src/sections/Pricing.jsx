...
export default function Pricing() {
  ...
  return (
    <div id="pricing" className="w-full lg:px-[200px] px-8 py-[60px] h-full flex flex-col items-center gap-10">
      {/* Section Header */}
      <h1
        className="text-4xl uppercase text-white font-poppins font-semibold sm:text-left"
        data-aos="fade-down"
      >
        Paths to Devotion
      </h1>
      ...
      <p
        className="text-gray-300 lg:w-[70%] w-full text-lg text-center"
        data-aos="fade-up"
      >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold">Seeker Path</h2>
          ...
          <button className="mt-8 bg-red-600 hover:bg-white hover:text-red-600 px-6 py-2 rounded-md font-semibold flex items-center gap-2 justify-center transition-all duration-300 cursor-pointer">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold">Devotee Path</h2>
            <p className="text-gray-400 text-sm">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold">Surrender Path</h2>
            <p className="text-gray-400 text-sm">
